...
describe('Integration: SSE Streaming', () => {
	...
	beforeAll(async () => {
		streamServer = createMockProvider((_req, res) => {
			...
			res.write('data: {"id":"c1","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"content":"Hello"}}]}\n\n');
			res.write('data: {"id":"c2","object":"chat.completion.chunk","choices":[{"index":0,"delta":{"content":" world"}}]}\n\n');
			res.write('data: [DONE]\n\n');
			res.end();
		});
