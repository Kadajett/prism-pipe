...
/**
 * Infer provider format from base URL.
 * Falls back to 'openai' for unknown providers (most compatible format).
 */
      ...
      try {
        ...
        const providers = providerNames
          ...
          .map((name) => {
            ...
            const format = inferProviderFormat(providerConf.baseUrl);
            return {
              config: providerConf,
